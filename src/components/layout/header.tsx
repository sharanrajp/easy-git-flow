        ...
        <div className="flex items-center space-x-4">
          ...
          {user.role !== "panel_member" && user.role !== "tpm_tem" && (
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 bg-card/95 backdrop-blur-xl border-border/50 shadow-elegant"
              >
          ...
          {(user.role === "panel_member" || user.role === "tpm_tem" || user.role === "recruiter") && (
            <Popover>
              ...
              {!["interview-assigned", "in_interview"].includes(user?.privileges?.status || "") && (
                <PopoverContent
                  align="end"
                  className="w-56 bg-card/95 backdrop-blur-xl border-border/50 shadow-elegant p-2 m-2"
                >
