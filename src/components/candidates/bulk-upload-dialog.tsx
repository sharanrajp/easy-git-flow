...
Jane Smith,jane.smith@email.com,+911234567891,Chennai,2,"Node.js,Python,MongoDB",Walk-In,1 month,8,10,No,Yes`
  ...
  return (
    <>
            ...
            <div className="space-y-4">
              ...
              {loadingLogs ? (
                ...
                (
                  <div className="overflow-x-auto w-full">
                    {(() => {
                      const startIndex = (skippedUploadLogsPage - 1) * itemsPerPage
                      const endIndex = startIndex + itemsPerPage
                      const paginatedSkipped = uploadLogs.slice(startIndex, endIndex)
                      const totalPages = Math.ceil(uploadLogs.length / itemsPerPage)
                        ...
                        <>
                              ...
                              {paginatedSkipped?.map((log) => (
                                ...
                                >
                                  ...
                                  <TableCell>
                                    <Badge
                                      variant="default"
                                      className="bg-success text-[#40474C] text-sm font-medium px-2 py-1"
                                    >
                                      {log.added_count}
                                    </Badge>
                                  </TableCell>
                          ...
                          {totalPages > 1 && (
                            <div className="flex justify-center pt-4">
                              <Pagination
                                currentPage={skippedUploadLogsPage}
                                totalPages={totalPages}
                                onPageChange={setSkippedUploadLogsPage}
                              />
                            </div>
                          )}
                        </>
      ...
      {showCandidateDialog && <AssignedCandidateDetails
