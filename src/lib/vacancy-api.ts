...
function transformBackendToFrontend(backendVacancy: BackendVacancy): Vacancy {
  return {
    ...
    title: backendVacancy.position_title,
    hiringManager: backendVacancy.hiring_manager_name,
    recruiterName: backendVacancy.recruiter_name,
    jobType: backendVacancy.job_type as "full-time" | "part-time" | "contract",
    priority: backendVacancy.priority as "P3" | "P2" | "P1" | "P0",
    numberOfVacancies: backendVacancy.number_of_vacancies,
    ...
    interviewTypes: [backendVacancy.interview_type] as "walk-in"[],
    walkInDetails: {
    ...
    jobDescription: backendVacancy.jobDescription || "",
...
function transformFrontendToBackend(frontendVacancy: Partial<Vacancy>): VacancyCreateRequest {
  return {
    position_title: frontendVacancy.title || "",
    hiring_manager_name: frontendVacancy.hiringManager || "",
    recruiter_name: frontendVacancy.recruiterName || "",
    job_type: frontendVacancy.jobType || "full-time",
    priority: frontendVacancy.priority || "P3",
    number_of_vacancies: frontendVacancy.numberOfVacancies || 1,
    ...
    interview_type: frontendVacancy.interviewTypes?.[0] || "walk-in",
